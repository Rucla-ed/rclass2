...
- While the term OAuth might be new to us, we interact with OAuth athentication daily. 
...
- __Arguments__  
    ...
    - `key` : The API key provided to your from Census formated in quotes. A key can be aquired at https://api.census.gov/data/key_signup.html  
...
Tidycensus functions (from tidycensus [website](https://walkerke.github.io/tidycensus/reference/index.html))

__Example__: using tidycensus  
...
#from will doyle lecture https://github.com/wdoyle42/hoddatasci/blob/master/lessons/07-webscraping.Rmd
