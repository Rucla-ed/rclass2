...
### Create new repository and publish it to GitHub

to create this example, can draw from both of these two tutorials:

- https://www.codecademy.com/articles/f1-u3-git-setup
- https://guides.github.com/introduction/git-handbook/
First [stuff to do on github before you do stuff on command line]
...
[karina: think of as downloading]
https://guides.github.com/introduction/git-handbook/
